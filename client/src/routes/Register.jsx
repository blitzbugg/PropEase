...
function Register() {
  ...
  return (
    <div className="flex min-h-[calc(100vh-64px)] w-full bg-slate-50">
        ...
        <div className="w-full max-w-md bg-white p-8 sm:p-10 rounded-3xl shadow-xl shadow-slate-200/60 border border-slate-100">
          ...
          <div className="mb-7">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-emerald-50 border border-emerald-200/60 text-emerald-700 text-xs font-semibold uppercase tracking-wider mb-4">
              ...
              Join South India's Top Network
            </div>
            <h1 className="text-3xl font-extrabold text-slate-900 tracking-tight">
              Create an Account
            </h1>
            <p className="text-slate-500 text-sm mt-1.5">
              Connect directly with verified owners, buyers, and tenants across South India.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col space-y-4">
            ...
            <button
              disabled={isLoading}
              className="w-full py-3.5 px-4 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold rounded-xl transition-all duration-200 shadow-lg shadow-emerald-600/25 active:scale-[0.99] disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2 mt-2"
            >
              {isLoading ? (
                <>
      ...
      {/* Right Column - South India Showcase Showcase Panel */}
        ...
        <div className="relative z-10 my-8 space-y-6">
          <div>
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-500/15 border border-emerald-400/30 text-emerald-300 text-xs font-semibold mb-3">
              ✨ List or Find Properties in Minutes
            </span>
            <h2 className="text-3xl xl:text-4xl font-black leading-tight text-white">
              The smartest way to rent, buy & sell in <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-300 to-teal-200">South India</span>
            </h2>
            <p className="text-slate-300 text-sm mt-3 leading-relaxed max-w-lg">
              Join thousands of buyers, tenants, and property owners making effortless property moves across Karnataka, Tamil Nadu, Kerala, Telangana & Andhra Pradesh.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3.5 pt-2">
            <div className="bg-white/10 backdrop-blur-md border border-white/15 rounded-2xl p-4 shadow-inner">
              ...
              <h4 className="text-sm font-bold text-white">Direct In-App Chat</h4>
              <p className="text-xs text-slate-300 mt-1">Chat securely and schedule site visits directly with verified owners.</p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-md border border-white/15 rounded-2xl p-4 shadow-inner">
              ...
              <h4 className="text-sm font-bold text-white">Verified Badges</h4>
              <p className="text-xs text-slate-300 mt-1">Listings verified with real site photos and land registry records.</p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-xs italic text-slate-200">
                "Listed our independent villa in Anna Nagar, Chennai and finalized tenants in just 2 days!"
              </p>
              <div className="flex items-center justify-between mt-1">
                <span className="text-[11px] font-semibold text-emerald-300">— Ananya & Venkat M.</span>
                <span className="text-[10px] text-slate-400">Property Owner</span>
              </div>
            </div>
          </div>
        </div>
