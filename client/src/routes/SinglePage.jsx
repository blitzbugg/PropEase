        ...
        <div className="w-full lg:w-1/3 bg-white rounded-xl shadow-md p-6 border border-gray-100">
          ...
          <div className="flex gap-4 mt-6">
            <button 
              ...
              disabled={isLoading}
              className="flex-1 bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition-colors flex items-center justify-center font-medium disabled:bg-blue-400"
            >
              {isLoading ? (
                <>
